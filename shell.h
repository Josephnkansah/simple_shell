...
void ourtop_eputs(char *);
int ourtop_eputchar(char);
int _putfd(char c, int fd);
int _putsfd(char *str, int fd);

/* built string function*/
int ourtop_strlen(char *);
int ourtop_strcmp(char *, char *);
char *starts_with(const char *, const char *);
char *_strcat(char *, char *);
char *ourtop_strcpy(char *, char *);
...
/* advance commands */
int ourtop_myexit(info_t *);
int ourtop_mycd(info_t *);
int _myhelp(info_t *);
...
int ourtop_getline(info_t *, char **, size_t *);
